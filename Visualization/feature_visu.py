...
from API.api_helper import retrieve_data
...
def load_id_data():
    ...
    data = retrieve_data(to_retrieve)
...
def load_ood_data():
    # Load OOD data
    to_retrieve = "SVHNvsCIFAR-10_resnet18-supcon_out_alllayers.npz"
    data = retrieve_data(to_retrieve)
...
def visuuu():
    ...
    ood_feat, ood_score = load_ood_data()
